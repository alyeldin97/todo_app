...
class _$TodoItemTearOff {
  ...
  _TodoItem call({UniqueId? id, TodoName? todoName, bool? done}) {
    return _TodoItem(
      id: id,
      todoName: todoName,
      done: done,
...
class _$_TodoItem extends _TodoItem {
  const _$_TodoItem({this.id, this.todoName, this.done}) : super._();
...
abstract class _TodoItem extends TodoItem {
  const factory _TodoItem({UniqueId? id, TodoName? todoName, bool? done}) =
      _$_TodoItem;
